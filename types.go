...
// ErrChromeUnavailable is returned when Chrome is not available and cache is expired
var ErrChromeUnavailable = errors.New("chrome unavailable and cache expired")
